/* Astro Night Planner 1.4.1 – Produktivversion */
'use strict';

const BUILD = Object.freeze(window.ANP_BUILD || {environment:'prod', appVersion:'1.4.1', release:'1.4.1', databaseName:'astro-night-planner-prod-v1', documentTitle:'Astro Night Planner 1.4.1'});
...
Object.assign(EN_EXACT,{
  ...
  'Windows: komfortables Kontrollfenster mit Tray und Autostart. Linux/macOS: natives Serverprogramm mit Browseroberfläche; kein Wine erforderlich.':'Windows: comfortable control window with tray and autostart. Linux/macOS: native server program with browser interface; Wine is not required.',

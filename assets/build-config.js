...
window.ANP_BUILD = Object.freeze({
  ...
  "badgeText": "",
  "documentTitle": "Astro Night Planner 1.4.3",
  "releaseNotes": {
    "de": [
      "🟨 WICHTIG: ANP-Local-Survey-Server.exe vollständig über das Tray-Menü beenden und durch die EXE aus dem aktualisierten Paket ANP Local Survey Server 1.1 ersetzen. Der Dateiname bleibt unverändert."
    ],
    "en": [
      "🟨 IMPORTANT: Fully exit ANP-Local-Survey-Server.exe from its tray menu and replace it with the executable from the updated ANP Local Survey Server 1.1 package. The executable name remains unchanged."
    ]
  },
  "criticalUpdate": {
    "de": "ANP-Local-Survey-Server.exe vollständig über das Tray-Menü beenden und durch die EXE aus dem aktualisierten Paket ANP Local Survey Server 1.1 ersetzen. Der Dateiname bleibt unverändert.",
    "en": "Fully exit ANP-Local-Survey-Server.exe from its tray menu and replace it with the executable from the updated ANP Local Survey Server 1.1 package. The executable name remains unchanged."
  },
  "detailsUrl": {
    "de": "docs/NEUERUNGEN_DE.html",
    "en": "docs/NEUERUNGEN_EN.html"
  },
  "versionHistory": {
    "de": {
      "version143": {
        "title": "1.4.3 gegenüber 1.4.2",
        "items": [
          "ANP Local Survey Server 1.1 mit robusteren Downloads: temporäre Netzwerkfehler, Timeouts und HTTP 429/5xx werden pro Datei automatisch wiederholt.",
          "Ein einzelner Verbindungsabbruch beendet nicht mehr den gesamten Survey-Download; nach dem Hauptlauf folgt ein automatischer Wiederholungsdurchlauf für verbliebene Dateien.",
          "Unvollständige .part-Dateien werden weiterverwendet; vollständig geladene Dateien bleiben erhalten und werden beim Fortsetzen übersprungen.",
          "Downloads von www.simg.de verwenden zwei parallele Verbindungen, andere Quellen standardmäßig vier, um die Quellserver weniger zu belasten.",
          "Der Downloadstatus zeigt Wiederholungsversuch, Wartezeit, fehlgeschlagene Dateien und Anzahl paralleler Verbindungen.",
          "Das Windows-Tray-Menü wurde stabilisiert, nach Neustarts des Windows-Explorers wiederhergestellt und um eine Sicherheitsabschaltung beim Beenden ergänzt.",
          "Hilfe, HTML-Anleitungen und Handbuch wurden auf Deutsch und Englisch aktualisiert."
        ]
      },
      "version142": {
        "title": "1.4.2 gegenüber 1.4.1",
        "items": [
          ...
          "Vorbelegte und geprüfte Quelladressen und relative Zielpfade für DSS2, PanSTARRS, VTSS, Finkbeiner, WISE, 2MASS, IRIS und alle sechs NSNS-Surveys.",
    ...
    "en": {
      "version143": {
        "title": "1.4.3 compared with 1.4.2",
        "items": [
          "ANP Local Survey Server 1.1 with more robust downloads: temporary network errors, timeouts and HTTP 429/5xx are retried automatically for each file.",
          "A single interrupted connection no longer stops the complete survey download; a recovery pass retries remaining files after the main pass.",
          "Incomplete .part files are reused; complete files remain available and are skipped when resuming.",
          "Downloads from www.simg.de use two parallel connections; other sources use four by default to reduce load on source servers.",
          "Download status shows retry attempt, wait time, failed files and parallel connection count.",
          "The Windows tray menu was stabilised, restored after Windows Explorer restarts and given a safety fallback for exit.",
          "Help, HTML guides and manual were updated in German and English."
        ]
      },
      "version142": {
        "title": "1.4.2 compared with 1.4.1",
        "items": [
          ...
          "Preconfigured and verified source URLs and relative target paths for DSS2, PanSTARRS, VTSS, Finkbeiner, WISE, 2MASS, IRIS and all six NSNS surveys.",
      ...
      "version141": {
        "title": "1.4.1 compared with 1.4.0",
        "items": [
      ...
      "version140": {
        "title": "1.4.0 compared with 1.3.0",
        "items": [
      ...
      "version130": {
        "title": "1.3.0 compared with 1.2.0",
        "items": [
      ...
      "version120": {
        "title": "1.2.0 compared with 1.1.0",
        "items": [
      ...
      "version110": {
        "title": "1.1.0 compared with 1.0.0",
        "items": [
